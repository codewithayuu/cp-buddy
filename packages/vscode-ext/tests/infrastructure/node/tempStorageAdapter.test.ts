...
describe('TempStorageAdapter', () => {
  ...
  it('should create a new path using crypto and settings when pool is empty', () => {
    ...
    expect(path).equals('/tmp/cpbuddy/u-u-i-d-0');
  ...
  it('should manage multiple paths in the pool correctly', () => {
    ...
    expect(p1).equals('/tmp/cpbuddy/u-u-i-d-0');
    expect(p2).equals('/tmp/cpbuddy/u-u-i-d-1');
    expect(p3).equals('/tmp/cpbuddy/u-u-i-d-2');
    expect(r1).equals('/tmp/cpbuddy/u-u-i-d-0');
    expect(r2).equals('/tmp/cpbuddy/u-u-i-d-1');
    expect(r3).equals('/tmp/cpbuddy/u-u-i-d-3');
