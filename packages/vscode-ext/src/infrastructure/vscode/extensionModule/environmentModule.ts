    ...
    this.timer = setInterval(async () => {
      ...
      if (
        ...
        const msg = this.translator.t(
          "CPBuddy cannot run with CPH, but it can load CPH problem file. Please disable CPH to use CPBuddy. You can select the 'Ignore' option to ignore this warning in this session.",
        );
