...
export default defineConfig({
  ...
  manifest: ({ browser }) => {
    ...
    const permissions = ['activeTab', 'storage', 'unlimitedStorage', 'scripting', 'notifications', 'clipboardWrite'];
    ...
    return {
      ...
      commands: {
        ...
        'send-to-sublime': {
          ...
          description: 'Send Problem to CPBuddy/Sublime'
        },
        'open-submissions': {
          description: 'Open My Submissions Page'
        }
      },
